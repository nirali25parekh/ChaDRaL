...
def decrypt(image,fx,fy,fz,file_path,Mk,bt,gt,rt):
...
if (__name__ == "__main__"):
    ...
    print(file_path)# https://github.com/tafseerahmed/image-Encryption-dna-encoding/blob/master/encr.py
# Aim: create a image encryption program using Dna encoding and chaos map
...
if (__name__ == "__main__"):
    ...
    #* 4-> get DNA letters A,C,G,T back to bits (so image original size maintained)
    b,g,r=dna_decode(blue_scrambled,green_scrambled,red_scrambled)
